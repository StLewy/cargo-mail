package com.sl.cargomail.utility;
...
import static com.sl.cargomail.constant.SecurityConstant.*;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal){
        ...
        return JWT.create().withIssuer(GET_ARRAYS_LIC).withAudience(GET_ARRAYS_ADMINISTRATION)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(GET_ARRAYS_LIC).build();
